    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="text-white text-lg mb-4">Cursos Tech</h3>
            <p className="text-sm mb-4">
              Transformando vidas a través de la educación tecnológica. Aprende las habilidades más demandadas del mercado.
            </p>
          ...
          {/* Cursos */}
          <div>
            <h3 className="text-white text-lg mb-4">Cursos Populares</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>contacto@cursostech.com</span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center text-sm">
          <p>
            © {currentYear} Cursos Tech. Todos los derechos reservados. Hecho con ❤️ para estudiantes apasionados por la tecnología.
          </p>
        </div>
      </div>
    </footer>
